...
public class TestZone {
	...
	public static void main(String[] args) {	
	    ...
	    // ColumnsFirst
	    loserNetwork.setColumnsFirst(true);	    
	    sassyNetwork200.setColumnsFirst(true);
	    moodyNetwork400.setColumnsFirst(true);
	    wiseNetwork600.setColumnsFirst(true);    
	    kawaiiNetwork800.setColumnsFirst(true);
	    winnerNetwork1000.setColumnsFirst(true);
